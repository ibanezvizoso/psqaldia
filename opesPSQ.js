    ...
    modalData.innerHTML = `
        <div style="padding: 2.5rem 1.5rem; text-align: center; max-width: 500px; margin: auto;">
            <div style="margin-bottom: 2.5rem;">
                ...
                <h2 style="color: var(--text-main); font-weight: 900; margin: 0; font-size: 1.8rem;">Exámenes OPE</h2>
                <p style="color: var(--text-muted); font-size: 0.95rem; margin-top: 0.5rem;">Selecciona la convocatoria para comenzar</p>
            </div>
            
            <div style="display: grid; gap: 15px;">
                <button onclick="iniciarExamen('22')" style="padding: 1.2rem; border-radius: 20px; border: 2px solid var(--border); background: var(--card); cursor: pointer; transition: all 0.2s ease; display: flex; align-items: center; justify-content: space-between; text-align: left;">
                    <div>
                        <b style="display: block; color: var(--text-main); font-size: 1.1rem;">Convocatoria 2022</b>
                        <small style="color: var(--text-muted);">Pestaña: Ope_PSQ22</small>
                    </div>
                    <i class="fas fa-chevron-right" style="color: var(--primary);"></i>
                </button>

                <button onclick="iniciarExamen('20')" style="padding: 1.2rem; border-radius: 20px; border: 2px solid var(--border); background: var(--card); cursor: pointer; transition: all 0.2s ease; display: flex; align-items: center; justify-content: space-between; text-align: left;">
                    <div>
                        <b style="display: block; color: var(--text-main); font-size: 1.1rem;">Convocatoria 2020</b>
            ...
            <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:2rem; border-bottom: 2px solid var(--border); padding-bottom:1.5rem;">
                <div>
                    ...
                    <p style="margin:5px 0 0; font-size:0.85rem; font-weight:700; color:var(--text-muted); text-transform:uppercase;">
                        Preguntas: <span id="contador-preg">${preguntasVisibles}</span> de ${preguntasExamen.length}
                    </p>
                </div>
