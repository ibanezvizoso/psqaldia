...
window.iniciarInterfazCalculadora = async function() {
    ...
    if (!document.getElementById('calc-internal-styles')) {
        ...
        styleTag.innerHTML = `
            ...
            .calc-ui h2 { margin: 0 0 1rem 0; font-weight: 800; }
            ...
            .btn-primary { margin-top: 1rem; padding: 1.1rem; background: var(--primary); color: white; border: none; border-radius: 1.2rem; cursor: pointer; font-weight: 900; }
    ...
    if (!window.dbCalc) {
        try {
            ...
            if (data.values) {
                ...
                // --- MAPA DE ESTRATEGIA (Fila 13 / Índice 12) ---
                ...
                // --- MAPA DE FÁRMACOS (Columna A, desde A2 / Índice 1) ---
    ...
    // 3. RENDER (Usa dbCalc que ya tiene Haloperidol en A2 como primero)
...
window.ejecutarCalculo = function() {
    ...
    // Buscar ambos en dbCalc (Columna A) para la conversión
    ...
    // Buscar Estrategia: Fila del Origen (A) vs Columna del Destino (Fila 13)
    const filaIdx = o.filaIdx;
    const colIdx = window.mapDestinoSwitch[fDestNom.toUpperCase()];
...
// 5. TRADUCTOR DE PASOS (Igual que el tuyo, que funciona)
