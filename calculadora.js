...
        resAlert.innerText = "ALERTA: EXCEDE DOSIS MÁXIMA en ficha técnica";
        resAlert.style.color = "#b91c1c";
    } else if (Maudsley > d.ed95) {
        resBox.style.background = '#fef3c7'; // Amarillo/Naranja suave
        resAlert.innerText = "AVISO: SUPERIOR A EFICACIA MÁXIMA (ED95) según Leucht et al. Valorar balance riesgo/beneficio.";
        resAlert.style.color = "#b45309";
    } else if (Maudsley < d.min) {
        resBox.style.background = '#f1f5f9'; // Gris suave
        resAlert.innerText = "DOSIS POR DEBAJO DEL MÍNIMO EFECTIVO para primer episodio psicótico";
